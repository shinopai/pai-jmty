    ...
    <div class="wrap vertical_padding">
      <form action="{{ url('/register') }}" method="post" class="basic__form" enctype="multipart/form-data">
        ...
        <div class="basic__form--item">
          <label for="nickname" class="basic__form--label">ニックネーム(10文字以内)</label><br>
          <input type="text" name="nickname" id="nickname" class="basic__form--input" value="{{ old('nickname') }}" placeholder="例) ジモティー">
        </div>
        <div class="basic__form--item">
        ...
        <div class="basic__form--item">
          <label for="password_confirmation" class="basic__form--label">パスワード(確認)</label><br>
          <input type="password" name="password_confirmation" id="password_confirmation" class="basic__form--input" value="">
        </div>
        <div class="basic__form--item">
        ...
        <div class="basic__form--item">
          <label for="comment" class="basic__form--label">コメント</label><br>
          <textarea name="comment" id="comment" class="basic__form--textarea" placeholder="例) 良い取引が出来るよう願ってます。宜しくお願いします。" rows="10">{{ old('comment') }}</textarea>
        </div>
        <div class="basic__form--item">
